        ...
        "data": [
            {
                ...
                "customer": {
                    ...
                    "accounting_sync_configuration": {
                        "excluded": True,
                        "accounting_providers": [{"provider_type": "quickbooks", "external_provider_id": "string"}],
                    },
                ...
                "plan": {
                    ...
                    "status": "active",
                    "maximum": {"maximum_amount": "string", "applies_to_price_ids": ["string"]},
                    "minimum": {"minimum_amount": "string", "applies_to_price_ids": ["string"]},
                    "discount": {
                    ...
                    "product": {"created_at": "2024-06-21T22:27:22.234Z", "id": "string", "name": "string"},
                    "version": 0,
                    "trial_config": {"trial_period": 0, "trial_period_unit": "days"},
                    "plan_phases": [
                        {
                            "id": "string",
                            "description": "string",
                    ...
                    "base_plan": {"id": "m2t5akQeh2obwxeU", "external_plan_id": "m2t5akQeh2obwxeU", "name": "Example plan"},
                    "base_plan_id": "string",
                ...
                "status": "active",
                "trial_info": {"end_date": "2024-06-21T22:27:22.237Z"},
                "active_plan_phase_order": 0,
                "fixed_fee_quantity_schedule": [
                    {"price_id": "string", "start_date": "2024-06-21T22:27:22.237Z", "end_date": "2024-06-21T22:27:22.237Z", "quantity": 0}
                ],
                "default_invoice_memo": "string",
                "auto_collection": True,
                "net_terms": 0,
                ...
                "price_intervals": [
                    {
                        ...
                        "price": {
                            ...
                            "cadence": "one_time",
                            "billable_metric": {"id": "string"},
                            "fixed_price_quantity": 0,
                            "plan_phase_order": 0,
                            "currency": "string",
                            "conversion_rate": 0,
                            "item": {"id": "string", "name": "string"},
                            "credit_allocation": {"currency": "string", "allows_rollover": True},
                            "discount": {
                                "discount_type": "percentage",
                                "applies_to_price_ids": ["h74gfhdjvn7ujokd", "7hfgtgjnbvc3ujkl"],
                                "reason": "string",
                        ...
                        "fixed_fee_quantity_transitions": [
                            {"price_id": "string", "effective_date": "2024-06-21T22:27:22.246Z", "quantity": 0}
                        ],
                ...
                "adjustment_intervals": [
                    {
                        ...
                        "applies_to_price_interval_ids": ["string"],
                    }
                ],
                "discount_intervals": [{}, {}, {}],
                "minimum_intervals": [
