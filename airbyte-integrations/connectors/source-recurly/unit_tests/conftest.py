...
@fixture
def config_pass():
    return {"api_key": "abcd1234"}


@fixture
def incremental_config_pass():
    return {"api_key": "abcd1234", "begin_time": "2024-01-10T00:00:00Z", "end_time": "2024-07-01T23:59:59Z"}
        ...
        "data": [
            {
                ...
                "billing_info": {
                    ...
                    "payment_method": {
                        ...
                        "exp_month": 11,
                        "exp_year": 2020,
                        "card_network_preference": None,
                    },
                    "created_at": "2024-04-20T15:52:10Z",
                    "updated_at": "2024-04-20T15:52:10Z",
                    "updated_by": {"ip": None, "country": None},
                    "fraud": None,
                },
                "cc_emails": "",
                "code": "test-account1",
                "company": "",
                "created_at": "2024-04-20T03:42:49Z",
                "custom_fields": [],
                "deleted_at": None,
                ...
                "shipping_addresses": [
                    {
                        ...
                        "id": "nwnsbcqp9u6c",
                        "account_id": "abc",
                        "created_at": "2024-04-20T15:15:04Z",
                        "updated_at": "2024-04-20T15:15:04Z",
                    }
                ],
                "state": "active",
                "tax_exempt": False,
        ...
        "data": [
            {
                ...
                "coupon": {
                    ...
                    "object": "coupon",
                    "code": "aaja1xpwrotu",
                    "name": "Integration Coupon test number 1",
                    "state": "redeemable",
                    "max_redemptions": None,
                    "max_redemptions_per_account": None,
                    "duration": "forever",
                    "temporal_unit": None,
                    "temporal_amount": None,
                    "applies_to_all_plans": True,
                    "applies_to_all_items": False,
                    "applies_to_non_plan_charges": False,
                    "redemption_resource": "Account",
                    "discount": {"type": "percent", "percent": 97},
                    "coupon_type": "single_code",
                    "hosted_page_description": None,
                    "invoice_description": None,
                    "unique_coupon_codes_count": 0,
                    "unique_code_template": None,
                    "unique_coupon_code": None,
                    "plans": None,
                    "items": None,
                    "redeem_by": None,
                    "created_at": "2024-04-24T12:14:40Z",
                    "updated_at": "2024-04-23T02:51:38Z",
                    "expired_at": None,
                },
                "state": "inactive",
                "currency": "USD",
                "discounted": 0.0,
                "created_at": "2024-04-23T02:51:32Z",
                "updated_at": "2024-04-23T02:51:39Z",
        ...
        "data": [
            {
                ...
                "user": {
                    ...
                    "last_name": "Airbyte",
                    "time_zone": None,
                    "created_at": "2024-04-21T04:05:42Z",
                    "deleted_at": None,
                },
                "message": "This is a second test note because two notes is better than one.",
                "created_at": "2024-04-21T20:42:25Z",
            }
        ],
        "has_more": False,
    }
        ...
        "data": [
            {
                ...
                "applies_to_non_plan_charges": False,
                "redemption_resource": "Account",
                "discount": {"type": "percent", "percent": 12},
                "coupon_type": "single_code",
                "hosted_page_description": None,
                "invoice_description": None,
                "unique_coupon_codes_count": 0,
                ...
                "items": None,
                "redeem_by": None,
                "created_at": "2024-04-24T11:55:23Z",
                "updated_at": "2024-04-24T11:55:23Z",
                "expired_at": None,
            }
        ],
        "has_more": False,
