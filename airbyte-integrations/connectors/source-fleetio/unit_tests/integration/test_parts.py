...
_STREAM_NAME = "parts"
_TEMPLATE_NAME = "parts"
_RECORDS_PATH = FieldPath("parts")
_API_URL = "https://secure.fleetio.com/api"
_API_VERSION = "2024-03-15"


def _a_part() -> RecordBuilder:
...
def _parts_response() -> HttpResponseBuilder:
