...
_TEMPLATE_NAME = "contacts"
_RECORDS_PATH = FieldPath("contacts")
_API_URL = "https://secure.fleetio.com/api"
_API_VERSION = "2024-03-15"


def _a_contact() -> RecordBuilder:
...
def _contacts_response() -> HttpResponseBuilder:
