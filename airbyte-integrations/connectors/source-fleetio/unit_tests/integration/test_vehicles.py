...
_STREAM_NAME = "vehicles"
_TEMPLATE_NAME = "vehicles"
_RECORDS_PATH = FieldPath("vehicles")
_API_URL = "https://secure.fleetio.com/api"
_API_VERSION = "2024-03-15"


def _a_vehicle() -> RecordBuilder:
...
def _vehicles_response() -> HttpResponseBuilder:
